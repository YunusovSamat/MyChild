...
from app.db.my_child.models import Bill, Educator, Food, Parent, Gallery
...
class GalleryCreatePydantic(BaseModel):
    description: str
    photo_base64: str


GalleryPydantic = pydantic_model_creator(Gallery)
